...
class StructureGroupeAppellation extends AppellationHandler implements AppellationHandlerInterface
{
    ...
    {
        return ($object instanceof StructureGroupe);
    }
     ...
     */
    public function appellation($structureGroupe)
    {
        return $structureGroupe->__toString();
    }
     ...
     */
    public function appellationHtml($structureGroupe)
    {
        return $this->appellation($structureGroupe);
    }
}
