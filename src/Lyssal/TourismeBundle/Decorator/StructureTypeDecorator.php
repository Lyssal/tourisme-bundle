...
/**
 * Helper de StructureType.
 * 
 * @author Rémi Leclerc
 */
class StructureTypeDecorator extends DecoratorHandler implements DecoratorHandlerInterface
{
    /**
     * (non-PHPdoc)
    ...
    {
        return ($entity instanceof StructureType);
    }
